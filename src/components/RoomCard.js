    ...
    <div className="flex flex-col w-80 gap-8 bg-stone-100 shadow-md rounded-md">
      ...
      <div className="mx-4 mb-6">
        ...
        <p className=" my-3 font-medium">
          Type: <span className="font-normal font-mono">{room.type}</span>
        </p>
        ...
        <div className="flex justify-between gap-4 mt-4">
          <button
            ...
            className=" border-red-400 text-red-400 hover:text-red-500 hover:border-red-500 hover:bg-red-200 border-solid border py-2 rounded-lg w-36 text-center transition duration-200 box-border"
          >
            Availability
          </button>
          <button
            onClick={() => navigate(`/room/${room._id}/book`)}
            className="bg-red-400 hover:bg-red-500 py-2 rounded-lg w-36 text-center text-neutral-50  transition duration-200 font-semibold"
          >
            Reserve
          </button>
        </div>
